...
class RankingFeatureSection: UIView {
...
extension RankingFeatureSection: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setupCell(rankingFeature: rankingFeatureList[indexPath.row])
        return cell
    }
}

extension RankingFeatureSection: UICollectionViewDelegateFlowLayout {
...
private extension RankingFeatureSection {
    func setupViews() {
        // view add
    ...
    func fetchData() {
        ...
        do {
            ...
            fatalError("fatal error : converting data from feature plist is failed")
        }
    }
}
